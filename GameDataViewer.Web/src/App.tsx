        ...
        <div className="ml-auto flex items-center gap-3">
          {saveData && (
            <span className="text-xs text-gray-600">
              {saveData.sectors.length} sectors · {saveData.stations.length} stations · {saveData.ships.length} ships
            </span>
          )}
      ...
      <main className="flex-1 overflow-hidden">
        {!saveData ? (
          ...
          <div className="flex h-full">
            ...
            {/* Sector detail panel — shown when a sector is selected */}
            {selectedMacro && (
              <div className="w-[760px] flex-shrink-0 h-full overflow-hidden">
                <SectorPanel
