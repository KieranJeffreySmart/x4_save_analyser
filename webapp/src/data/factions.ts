...
export const factions: FactionInfo[] = [
  ...
  { key: 'smuggler',         color: '#aa4444', label: 'Smuggler' },
  ...
  { key: 'scaleplate',       color: '#bb4444', label: 'Scaleplate' },
  { key: 'xenon',            color: '#ff0000', label: 'Xenon' },
  ...
  { key: 'yaki',             color: '#dd3333', label: 'Yaki' },
  { key: 'buccaneers',       color: '#bb4422', label: 'Buccaneers' },
